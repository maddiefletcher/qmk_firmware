...
/* Vim Movement
 * ,-----------------------------------------------------------------------------------.
 * | RGBT | RGBH-| RGBH+| RGBS+| RGBS-|      | RGBS | RGBB | RGBS | RGBS | RGBB | RGBS |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | RGBV+| Home | PgDn | PgUp |  End |      | Left | Down |  Up  | Right|      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | RGBV-|      |      |      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      |      |      |      |      |
...
[_MOVE] = { /* Use vim keys for cursor movement */
  {RGB_TOG,     RGB_HUD,  RGB_HUI,  RGB_SAI,  RGB_SAD,  _______,  RGB_M_P,  RGB_M_B,  RGB_M_R,  RGB_M_SW, RGB_MOD,  RGB_RMOD},
  {RGB_VAI,     KC_HOME,  KC_PGDN,  KC_PGUP,  KC_END,   _______,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  _______,  _______},
 ...
 */
[_ADJUST] = {
  {  HYPR(KC_1),  QWERTY,    _______,    _______,      RESET, HYPR(KC_T),    _______,    _______, HYPR(KC_I),    _______, HYPR(KC_P),    KC_DEL },
